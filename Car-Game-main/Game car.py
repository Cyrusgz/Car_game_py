...
carimg = pygame.image.load(img_path('car1.jpg'))
backgroundpic = pygame.image.load(img_path("grass.jpg"))
yellow_strip = pygame.image.load(img_path("yellow_strip.jpg"))
strip = pygame.image.load(img_path("strip.jpg"))
intro_background = pygame.image.load(img_path("background.jpg"))
instruction_background = pygame.image.load(img_path("background2.jpg"))
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load(img_path("car1.jpg"))
    elif obs==1:
        obs_pic=pygame.image.load(img_path("car2.jpg"))
    elif obs==2:
        obs_pic=pygame.image.load(img_path("car2.jpg"))
    elif obs==3:
        obs_pic=pygame.image.load(img_path("car4.jpg"))
    elif obs==4:
        obs_pic=pygame.image.load(img_path("car5.jpg"))
    elif obs==5:
        obs_pic=pygame.image.load(img_path("car6.jpg"))
    elif obs==6:
        obs_pic=pygame.image.load(img_path("car7.jpg"))
